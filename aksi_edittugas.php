...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Cek apakah judul_tugas tidak kosong
    if (!empty($judul_tugas)) {
        $update_fields[] = "judul_tugas='$judul_tugas'";
    }
    ...
    if (!empty($update_fields)) {
        ...
        // Query untuk melakukan update data tugas
        $query = "UPDATE tugas SET $update_query WHERE id_tugas='$id_tugas'";
